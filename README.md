...
- Exception Handling & Clean Code Practices  
...
A backend banking application built using Spring Boot and Java, implementing real-world banking operations through RESTful APIs.
...
- 🏦 **Concurrent Banking System (Java)**  
  Implemented real-world banking operations using OOP, multithreading, and synchronization.

- 📊 DSA Practice & Algorithm Implementation  
  Regular problem-solving and optimization practice.
...
![LeetCode Stats](https://leetcard.jacoblin.cool/Divya-Sonawane?theme=dark&font=Baloo)
